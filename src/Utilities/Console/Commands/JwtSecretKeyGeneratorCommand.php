...
namespace coreapi\Utilities\Console\Commands;

use Illuminate\Console\Command;
use Illuminate\Console\ConfirmableTrait;
use Illuminate\Support\Str;

class JwtSecretKeyGeneratorCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->laravel['config']['coreapi.jwt_secret'] = $key;
    ...
    {
        $currentKey = $this->laravel['config']['coreapi.jwt_secret'] ?: env('JWT_SECRET_KEY');
    ...
    protected function keyReplacementPattern(): string
    {
        ...
        return "/^JWT_SECRET_KEY{$escaped}/m";
    }
}